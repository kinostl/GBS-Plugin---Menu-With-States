...
<tileset version="1.10" tiledversion="1.12.1" name="frame" tilewidth="8" tileheight="8" tilecount="9" columns="3">
 <image source="../assets/ui/frame.png" width="24" height="24"/>
 <wangsets>
  <wangset name="Default" type="corner" tile="-1">
   <wangcolor name="White on White" color="#ff0000" tile="-1" probability="1"/>
